...
def Home():
  ...
  "<li><strong> List of population:</strong><font color='orange'> /api/v1.0/population</font></li>"
  "<li><strong>Gender percentage:</strong><font color='orange'> /api/v1.0/bygender</font></li></ol></div>")
#===================================================
