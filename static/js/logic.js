...
var geoData = "https://chronicdata.cdc.gov/resource/hn4x-zwk7.geojson";
//var geoData = "static/data/data5.geojson";
...
console.log(data);
  ...
  geojson = L.choropleth(data, {
    ...
    onEachFeature: function(feature, layer) {
      layer.bindPopup("sample size: " + feature.properties.sample_size + "<br>Percentage of people with Obesity:<br>" +
